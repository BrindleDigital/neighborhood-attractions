	...
	<div class="na-metabox">
		...
		<div class="na-meta-option">
			...
			<div class="column">                
				...
				<p class="description">To import many attractions at once, visit the <a href="/wp-admin/edit.php?post_type=attractions&page=attractions-imports">Attractions Imports</a> page and download the <code>sample-upload.csv</code>.</p>
			</div>
		</div>
