 ...
 */
function na_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function na_hide_if_no_cats( $field ) {
 ...
 */
function na_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function na_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function na_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'na_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function na_register_demo_metabox() {
	/**
	...
	$cmb_demo->add_field( array(
		...
		'id'         => 'na_demo_text',
		'type'       => 'text',
		'show_on_cb' => 'na_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'na_display_text_small_column', // Output the display of the column values through a callback.
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'na_demo_textmedium',
		'type' => 'text_medium',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'na_demo_render_row_cb',
		'type' => 'text',
		'render_row_cb' => 'na_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'na_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'na_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'na_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'na_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'na_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field( array(
		...
		'id'           => 'na_demo_parameters',
		'type'         => 'text',
		'before_row'   => 'na_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'na_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function na_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'na_theme_options_page',
		...
		'option_key'      => 'na_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'              => 'na_options_page_message_callback',
 ...
 * }
 */
function na_options_page_message_callback( $cmb, $args ) {
